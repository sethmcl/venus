...
Plugins.prototype.checkDependencies = function (plugins) {
  ...
  Object.keys(plugins).forEach(function (pluginName) {
    var dependencies = this.pluginInstances[pluginName].dependencies;
    ...
    if (typeof dependencies !== 'object') {
      this.log.warn('Dependencies for %s were not read. Please specify dependencies as an object.', pluginName);
      return;
    }
